class Protobuf < Formula
  ...
  def install
    ...
    cmake_args = %W[
      ...
      # Tests disabled on macOS 10.15: abseil (compiled with Apple Clang 12) has
      # an ABI mismatch with test code compiled via Homebrew LLVM — absl::Cord's
      # string constructor is not present in the installed abseil dylib.
      # Matches upstream's rationale for disabling tests on Linux.
