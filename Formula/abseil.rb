class Abseil < Formula
  ...
  on_macos do
    ...
    # class declarations, causing build failures. Use Homebrew LLVM.
    # Also ensures ABI consistency with LLVM-compiled consumers (protobuf, grpc):
    # Apple Clang omits some absl::Cord template instantiations that LLVM-compiled
    # code expects to find in the shared dylib at link time.
