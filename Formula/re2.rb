class Re2 < Formula
  ...
  on_macos do
    # Build with LLVM for ABI consistency with LLVM-compiled abseil.
    # re2 links against abseil and should use the same compiler to avoid
    # potential symbol mangling mismatches in the abseil dependency chain.
